...
<body style="background-color: #D3D4C7">
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0c3b2e;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Poliklinik Kartini</a>
    ...
    if (isset($_GET['page'])) {
        ...
        echo "<br><h2>Selamat Datang di Poliklinik Kartini";

        if (isset($_SESSION['username' . 'nama'])) {
            // jika sudah login tampilkan username
            echo ", " . $_SESSION['username' . 'nama'] . "</h2><hr>";
        } else {
            echo "</h2><hr>Silakan login untuk mengakses sistem. Jika Anda belum memiliki akun, mohon daftar terlebih dahulu untuk dapat menggunakan layanan kami.";
        }
    }
    ?>
</body>
